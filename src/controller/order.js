...
module.exports = {
	...
	post: async (request, response) => {
		try {
			const randomId = ((min,max) => Math.floor(Math.random() * (max - min + 1)) + min)(1000000,9999999)
			...
			const setOrder = {user_id:currentUid, invoice_id:randomId, price:totalOrderPrice}
